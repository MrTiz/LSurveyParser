...
$sid       = 234479;
$tokens    = ['K2rxGkU589E2Wx5', 'RW6nuxj9nm7J8N3', '8WvVkxDpEqzHJCp'];
$questions = [
    '234479X1476X17332SQ001',
    '234479X1476X17332SQ003',
    '234479X1476X17340SQ001_SQ002',
    '234479X1476X17340SQ002_SQ003',
    '234479X1476X17348SQ001_SQ003',
    '234479X1476X17360SQ002',
    '234479X1476X17366SQ003'
];
...
try {
    ...
    $parsed = $parser->parseQuestionsByTokens($sid, $tokens, 'en', null, $questions);
} catch (Exception $e) {
